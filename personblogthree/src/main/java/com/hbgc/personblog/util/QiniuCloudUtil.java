...
public class QiniuCloudUtil {
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "wTHEDUv6Gn-UpEixixDyuhPeK_ox1KjwPlY0vxrg";
    private static final String SECRET_KEY = "9HiopsqtkyJPgJFtdNXILOblhLOkzQ_QTnX5Bw5A";

    // 要上传的空间
    private static final String bucketname = "personal-myblog-client";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

//    private static final String DOMAIN = "personal-myblog-client/image/";
    private static final String DOMAIN = "http://clientavatar.starstarcheng.cn/";
    /*对图片要求无限制，可以跳过*/
